...
releases
di repo ini
Download file ShutdownTimer.exe dari release terbaru
Double-click file tersebut — aplikasi langsung jalan, tidak perlu install .NET atau software tambahan apapun
...
.NET 8.0 SDK
Langkah: git clone GitHub - rangga123vibe-max/ShutdownTimer: Windows shutdown timer app - C# WPF · GitHub cd ShutdownTimer Buka file ShutdownTimer.sln dengan Visual Studio, lalu tekan F5 untuk menjalankan.

🖱️ Cara Menggunakan
Buka aplikasi Shutdown Timer
Masukkan durasi waktu (Jam, Menit, Detik) sebelum laptop shutdown
Klik START TIMER
Konfirmasi jadwal shutdown pada dialog yang muncul
Countdown akan berjalan otomatis, laptop akan shutdown saat mencapai 00:00:00
Jika ingin membatalkan, klik CANCEL SHUTDOWN kapan saja sebelum waktu habis
⚠️ Catatan Penting
...
Dibuat oleh rangga123vibe-max — by RanZx
